...
def login():
    ...
    CONTENT_PAGE = 'dashboard'
    return render_template('home.html', content=render_template('pages/dashboard.html', user=user), CONTENT_PAGE = CONTENT_PAGE, PAYMENT_STRIPE_DONE=PAYMENT_STRIPE_DONE)
...
def demo():
    ...
    return render_template('home.html',
                            ...
                            results=results), CONTENT_PAGE = CONTENT_PAGE, PAYMENT_STRIPE_DONE=PAYMENT_STRIPE_DONE)
